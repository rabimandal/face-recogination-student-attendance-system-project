...
class Face_Recognition:
    def __init__(self,root):
        ...
        #title section
        title_lb1 = Label(self.root,text="FACE RECOGNITION",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        #first image
        img_top=Image.open(r"college_images\fd11.jpg")
        ...
        #second image
        img_bottom=Image.open(r"college_images\frd.jpg")
        ...
        #button
        b1_1 = Button(f_lb1,text="Face Recognition",cursor="hand2",command=self.face_recog,font=("tahoma",16,"bold"),bg="darkgreen",fg="white")
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in featuers:
                ...
                if confidence > 77:
                    cv2.putText(img,f"Student_id:{i}",(x,y-75),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,225),3)
                    cv2.putText(img,f"Roll:{r}",(x,y-55),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,225),3)
